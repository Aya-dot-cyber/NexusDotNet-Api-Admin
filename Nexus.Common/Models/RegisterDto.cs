...
namespace Nexus.Common.Models
{
    public class RegisterDto
    {
        ...
        //[Remote(action: "IsEmailExist", controller: "Account", HttpMethod = "POST",
        //        ErrorMessageResourceType = typeof(Language), ErrorMessageResourceName = "EmailAlreadyExist")]
        ...
        [RegularExpression(@"^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[-_+=\[\]~\\\W_])\S{8,64}$",
                           ErrorMessageResourceName = "PasswordValidation", ErrorMessageResourceType = typeof(Language))]
        public string Password { get; set; }

        [DataType(DataType.PhoneNumber)]
        //[Remote(action: "IsPhoneExist", controller: "Account", HttpMethod = "POST", 
        //        ErrorMessageResourceType = typeof(Language), ErrorMessageResourceName = "PhoneNumberExist")]
